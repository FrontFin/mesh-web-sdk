...
var createFrontConnection = function (options) {
    var messageListener = function (event) {
        switch (event.data.type) {
            case types_1.EventType.AccessToken: {
            ...
            case types_1.EventType.DelayedAuth: {
                var payload = { delayedAuth: event.data.payload };
                (options === null || options === void 0 ? void 0 : options.onBrokerConnected) && options.onBrokerConnected(payload);
                break;
            }
            case types_1.EventType.SetTitle: {
                var data = event.data;
                if (isOriginalTitle) {
            ...
            case types_1.EventType.Loaded: {
                break;
            }
            case types_1.EventType.Exit:
            case types_1.EventType.Done: {
...
exports.createFrontConnection = createFrontConnection;
