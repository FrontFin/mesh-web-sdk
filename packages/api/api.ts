...
export interface B2BBrokerCreateOrderRequest {
  ...
  /**
   * This value indicates if the order should be executed in fiat amount (e.g. purchase ETH for $10). This can be
  ...
  /**
   * Specifies the target amount in fiat currency. For example setting this to `10` when the `AmountIsFiat` = `true`
...
export interface B2BPortfolioFisco {
  ...
  readonly totalScore?: 'veryPoor' | 'poor' | 'fair' | 'good' | 'exceptional'
  /** @format int32 */
  readonly maxFrontScore?: number
  /** @format int32 */
  readonly minFrontScore?: number
  /**
   * Front analyzes available financial data to reach a determination on risk associated with an asset based on its underlying financial conditions.
   * The Financials Score is a strong metric for investors who seek stocks that are underperforming and ripe for growth.
   */
  financialScore?: 'veryPoor' | 'poor' | 'fair' | 'good' | 'exceptional'
  /**
   * Front's proprietary algorithm performs advanced statistical analysis.
   ...
   */
  performanceScore?: 'veryPoor' | 'poor' | 'fair' | 'good' | 'exceptional'
  /**
   * Front Market Monitor autonomously crawls tens of thousands of websites
   * at a time and assigns each stock a score based on the news stories
   */
  newsScore?: 'veryPoor' | 'poor' | 'fair' | 'good' | 'exceptional'
  predictionScore?: 'veryPoor' | 'poor' | 'fair' | 'good' | 'exceptional'
  residualReturnScore?: 'veryPoor' | 'poor' | 'fair' | 'good' | 'exceptional'
   ...
   */
  esgScore?: 'veryPoor' | 'poor' | 'fair' | 'good' | 'exceptional'
  ...
  readonly isDiversificationScoreApplied?: boolean
}

export interface B2BPortfolioFiscoIApiResult {
  readonly content?: B2BPortfolioFisco | null
  readonly status?:
    | 'ok'
    | 'serverFailure'
    | 'permissionDenied'
...
export interface B2BStockFiscoIReadOnlyCollectionIApiResult {
  readonly content?: B2BStockFisco[] | null
  readonly status?:
    | 'ok'
    | 'serverFailure'
    | 'permissionDenied'
...
export type BrokerFeature = 'holdings' | 'balance' | 'orders' | 'transfers' | 'identity'
...
export type FiscoIngredientScoreEnum = 'veryPoor' | 'poor' | 'fair' | 'good' | 'exceptional'
...
export class FrontApi<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  frontScore = {
     ...
     *
     * @tags FrontScore
     * @name V1FrontscoreGetList
     * @summary Get portfolio Front Score
     * @request GET:/api/v1/frontscore/get
     * @secure
     * @response `200` `B2BPortfolioFiscoIApiResult` Front Score calculated.
     * @response `400` `ApiResult` Bad Request
    ...
    v1FrontscoreGetList: (
      ...
      this.request<B2BPortfolioFiscoIApiResult, ApiResult>({
        path: `/api/v1/frontscore/get`,
        method: 'GET',
        query: query,
        secure: true,
        format: 'json',
     ...
     *
     * @tags FrontScore
     * @name V1FrontscoreCryptocurrencyList
     * @summary Get cryptocurrency Front Score
     * @request GET:/api/v1/frontscore/cryptocurrency
     * @secure
     * @response `200` `B2BCryptocurrencyFiscoIReadOnlyCollectionIApiResult` Front Score calculated.
     * @response `400` `ApiResult` Bad Request
     * @response `401` `any` Unauthorized: Client Id or Client Secret are not correct or missing.
     */
    v1FrontscoreCryptocurrencyList: (
      query?: {
      ...
      this.request<B2BCryptocurrencyFiscoIReadOnlyCollectionIApiResult, ApiResult>({
        path: `/api/v1/frontscore/cryptocurrency`,
        method: 'GET',
        query: query,
        secure: true,
        format: 'json',
     ...
     *
     * @tags FrontScore
     * @name V1FrontscoreEquityList
     * @summary Get stock Front Score
     * @request GET:/api/v1/frontscore/equity
     * @secure
     * @response `200` `B2BStockFiscoIReadOnlyCollectionIApiResult` Front Score calculated.
     * @response `400` `ApiResult` Bad Request
     * @response `401` `any` Unauthorized: Client Id or Client Secret are not correct or missing.
     */
    v1FrontscoreEquityList: (
      query?: {
      ...
      this.request<B2BStockFiscoIReadOnlyCollectionIApiResult, ApiResult>({
        path: `/api/v1/frontscore/equity`,
        method: 'GET',
        query: query,
        secure: true,
        format: 'json',
