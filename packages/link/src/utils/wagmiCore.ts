...
// Initialize a variable to hold the dynamic configuration
// let dynamicConfig = null

// export const setConfig = config => {
//   try {
//     dynamicConfig = createConfig(config)
//     console.log('Configuration set successfully:', dynamicConfig)
//   } catch (error) {
...
//     console.log('event.data.payload wagmi config update', event.data.payload)
...
// export const configPreLoaded = createConfig({
//   chains: [mainnet, bsc, polygon, avalanche, arbitrum, optimism],
//   connectors: [
//     // injected(),
//     walletConnect({
