...
export interface B2BBrokerPortfolioModelApiResult {
  readonly status?:
    | 'ok'
    | 'serverFailure'
    | 'permissionDenied'
...
export interface InitializeTransfersForLinkRequest {
  ...
  clientFee?: number
  /** @format double */
  depositFeeInFiat?: number | null
  depositFeeTargetAddress?: string | null
  /**
...
export interface PreviewTransferRequest {
  ...
  fiatCurrency?: string | null
  /** @format double */
  depositFeeAmountInFiat?: number | null
  depositFeeTargetAddress?: string | null
}
...
export interface QuoteTransferResponse {
  ...
  isEligible?: boolean
  /**
   * Trading price of fiat to crypto pair
   * @format double
   */
  price?: number
  /**
...
export type TranferStatus = 'pending' | 'succeeded' | 'failed' | 'transferInitiated'
...
export interface TransferBalanceFundingAvailability {
   ...
   * @format double
   */
  gasFeeBufferAmount?: number | null
  symbol?: string | null
}
...
export interface TransferModel {
  ...
  userId?: string | null
  /** Transfer status. */
  status?: 'pending' | 'succeeded' | 'failed' | 'transferInitiated'
  /**
...
export class FrontApi<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  managedTransfers = {
    ...
    /**
     * @description Returns a list of cryptocurrency tokens with details including the symbol of the token and the supported networks and integrations
     *
     * @tags Managed Transfers
     * @name V1TransfersManagedTokensList
     * @summary Retrieve the list of all available cryptocurrency tokens.
  ...
  portfolio = {
     ...
     * @secure
     * @response `200` `B2BBrokerPortfolioModelApiResult` Holdings obtained
     * @response `400` `ApiResult` Bad Request
     * @response `401` `any` Unauthorized: Client Id or Client Secret are not correct or missing.
     */
    v1HoldingsGetCreate: (data: PortfolioBrokerBaseRequest, params: RequestParams = {}) =>
      this.request<B2BBrokerPortfolioModelApiResult, ApiResult>({
