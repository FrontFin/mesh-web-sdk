...
export interface B2BBrokerOrderStatus {
  orderStatus?: string | null
}

export interface B2BBrokerOrderStatusApiResult {
  readonly status?:
    | 'ok'
    | 'serverFailure'
    | 'permissionDenied'
  ...
  errorType?: string | null
  readonly errorData?: any
  content?: B2BBrokerOrderStatus | null
}
...
export type ExecuteTransferMfaType = 'unspecified' | 'phone' | 'email' | 'totp' | 'face' | 'tradingPin'
...
export class FrontApi<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  transactions = {
     ...
     *
     * @tags Transactions
     * @name V1TransactionsStatusDetail
     * @request GET:/api/v1/transactions/status/{brokerType}
     * @secure
     * @response `200` `B2BBrokerOrderStatusApiResult` Success
     */
    v1TransactionsStatusDetail: (
      brokerType:
        | 'robinhood'
        | 'eTrade'
        | 'alpaca'
      ...
      this.request<B2BBrokerOrderStatusApiResult, any>({
        path: `/api/v1/transactions/status/${brokerType}`,
        method: 'GET',
        query: query,
        secure: true,
        format: 'json',
